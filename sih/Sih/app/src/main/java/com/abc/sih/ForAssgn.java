...
public class ForAssgn extends Fragment {
    ...
    private void UpdateUI() {
        ...
        final Query allot = FirebaseDatabase.getInstance().getReference().child("ForRes").child(station).orderByChild("Assigned").equalTo(email);
    ...
    public  static class resourceHolder extends RecyclerView.ViewHolder{
        ...
        public void setDeAllocate(String type, String assgn, String list_user_id, String station) {
            ...
            DatabaseReference pol = FirebaseDatabase.getInstance().getReference().child("ForRes").child(station).child(list_user_id);
