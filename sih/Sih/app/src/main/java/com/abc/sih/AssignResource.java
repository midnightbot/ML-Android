...
public class AssignResource extends AppCompatActivity {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        resourceHolder.assign.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                resourceHolder.AssignPolice(list_user,id,type,adr,div,name);
                            }
                        });
    ...
    public static class resourceHolder extends RecyclerView.ViewHolder{
        ...
        public void AssignPolice(String list_user_id, String id, String type, String adr, String div, String name) {
            FirebaseDatabase.getInstance().getReference().child(div).child(adr).child(id).child("alloted").setValue("yes");
            FirebaseDatabase.getInstance().getReference().child(div).child(adr).child(id).child("Assigned").setValue(list_user_id);
            FirebaseDatabase.getInstance().getReference().child(div).child(adr).child(id).child("lastallocated").setValue(name);
