...
public class ResourceFragment extends Fragment {
    ...
    private void UpdateUI() {
        ...
        allot = FirebaseDatabase.getInstance().getReference().child("resource").child(station);
