...
public class AssignedFrag extends Fragment {
    ...
    private void UpdateUI() {
        ...
        final Query allot = FirebaseDatabase.getInstance().getReference().child("resource").child(station).orderByChild("Assigned").equalTo(email);
        FirebaseRecyclerAdapter<resource, resourceHolder> fr = new FirebaseRecyclerAdapter<resource, resourceHolder>(
            ...
            protected void populateViewHolder(final resourceHolder resourceHolder, resource resource, int i) {
                ...
                FirebaseDatabase.getInstance().getReference().child("resource").child(station).child(list_user_id).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(final DataSnapshot dataSnapshot) {
                        ...
                        resourceHolder.allot.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                resourceHolder.setDeAllocate(type,email,list_user_id,station);
    ...
    public  static class resourceHolder extends RecyclerView.ViewHolder{
        ...
        public void setDeAllocate(String type, String assgn, String list_user_id, String station) {
            ...
            DatabaseReference pol = FirebaseDatabase.getInstance().getReference().child("resource").child(station).child(list_user_id);
